...
instead of nine; the uncited behaviour-cohort, DPA↔GNG-balance and dPCA-push pages are gone.
  ...
  ED 1  pca/fig_ed2_plane.py            the plane per animal and out of context; GNG/test codes; CCGP
  ED 2  pca/fig_ed1_dimensionality.py   dimensionality: spectra, PR, shattering, per-mouse cvPCA, selection effect
  ED 3  pca/fig_ed6_dpca.py             demixed-PCA trajectories and axis alignment
  ED 4  overlaps/fig_ed3_coupling.py    push/coupling under units, decoders, a fixed axis, a lick covariate
  ED 5  overlaps/fig_ed4_chronic.py     chronic silencing of the two control projections
  ED 6  overlaps/fig_ed5_laser7.py      acute ON−OFF coupling over all seven laser mice
  (numbered by first citation since 2026-09-15; scripts keep their original names. SI trial counts = a table.)
...
FIGS = [(1, 'pca', 'fig_ed2_plane.py'), (2, 'pca', 'fig_ed1_dimensionality.py'),      # citation order (2026-09-15):
        (3, 'pca', 'fig_ed6_dpca.py'), (4, 'overlaps', 'fig_ed3_coupling.py'),             # scripts keep their names
        (5, 'overlaps', 'fig_ed4_chronic.py'), (6, 'overlaps', 'fig_ed5_laser7.py')]
MM = 183.0
