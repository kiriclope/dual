"""fig_ed4_chronic.py — Extended Data Fig. 4: chronic silencing of the two control projections during
...
CAP = [
    'Extended Data Fig. 4 | Chronic silencing of the two control projections during training (companion to '
