"""(RENUMBERED 2026-09-18 to citation order, ten figures after the unsupervised-geometry page was inserted as Extended Data Fig. 4: this script draws Extended Data Fig. 10.)
fig_ed5_laser7.py — Extended Data Fig. 10: the acute laser ON−OFF coupling over all seven laser mice
...
Output: /home/leon/dual/figures/ed/{png,svg}/ed_fig10.{png,svg}
"""
...
CAP = [
    'Extended Data Fig. 10 | The acute laser ON−OFF coupling over all seven laser mice (companion to Fig. 6g–i). '
...
fig.savefig(f'{OUT}/png/ed_fig10.png', bbox_inches='tight'); fig.savefig(f'{OUT}/svg/ed_fig10.svg', bbox_inches='tight')
print('saved', f'{OUT}/png/ed_fig10.png')
