"""fig_ed5_laser7.py — Extended Data Fig. 5: the acute laser ON−OFF coupling over all seven laser mice
...
CAP = [
    'Extended Data Fig. 5 | The acute laser ON−OFF coupling over all seven laser mice (companion to Fig. 6g–i). '
