...
BL = np.arange(0, 12); LD = np.arange(45, 54); ACT = np.arange(54, 63); SAMPLES = [('A', [0, 1]), ('B', [2, 3])]   # LD 45-53 = the main figure's BINS_LATE (T_WINDOW=0); fixed 2026-09-08 (was set_options 48-53 / 45-52)
