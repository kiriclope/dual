...
SUPP = [
    # ── THE EXTENDED DATA SET (native composites; ten figures numbered by first citation since 2026-09-18; make_ed_figures.py) ──
    ...
    ('ED Fig. 4 · geometry with no axes chosen: t-SNE maps (task/sample/choice), 20-draw kNN purity, matched-n per-mouse geometry (PR, sample & GNG separation), cross-validated unsupervised axes, UMAP DPA trajectories (a-f)',
     'figures/ed/png/ed_fig4.png'),
    ('ED Fig. 5 · the plane per animal & out of context: GNG/test codes, per-mouse CCGP (canonical windows, all trials), OOC plane test, plane-ablation grid (a-d)',
     'figures/ed/png/ed_fig5.png'),
    ('ED Fig. 6 · demixed-PCA trajectories (2×4) + axis alignment slopegraph with the refit mouse bootstrap (a-b)',
     'figures/ed/png/ed_fig6.png'),
    ('ED Fig. 7 · push/coupling under six units, three decoders, one pooled-stage CCGD axis (coupling reverses), trial-level lick control (a-d)',
     'figures/ed/png/ed_fig7.png'),
    ('ED Fig. 8 · PLACEHOLDER opto/imaging validation (histology, placements, FOVs, laser parameters — author-supplied)',
     'figures/ed/png/ed_fig8.png'),
    ('ED Fig. 9 · chronic silencing of the two control projections: ACC somata null, Prl→ACC impairs GNG (a-b)',
     'figures/ed/png/ed_fig9.png'),
    ('ED Fig. 10 · acute laser ON−OFF coupling over all 7 laser mice, Fig 6 estimator (GNG ρ=−0.94 p=.002; DPA trend = the ChR2 mice)',
     'figures/ed/png/ed_fig10.png'),
    ...
    ('ED 3c · per-mouse cvPCA companion — the memory spectrum is 1-D per animal (medians 0.90/0.93; expert mem-vs-dec p=.047, naive directional)',
