...
MAIN = [
    ...
    ('Fig 4 — POLISH variant  [schematic insets: set-point well (B) + axis-rotation glyph (A); data identical to canonical]',
     'overlaps/figures/overlaps/main/png/fig_overlaps_main_ab_dpaact_polish.png'),
    ('Fig 2/3 — 3-D condition-means embedding PREVIEW  [Bernardi-style; parallel A–B edges across tasks = the PS≈1 result; DECIDE: main or supp]',
