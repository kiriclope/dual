...
MAIN = [
    ...
    ('Fig 3 — manifold: abstract & reused across tasks',
     'overlaps/figures/overlaps/manifold/png/fig_overlaps_manifold.png'),
    ('Fig 3 (alt) — manifold on the antact+robust action axis (48–62) ★NEW',
    ...
    ('Fig 4 (alt) — push on the antact+robust action axis (48–62, random-slope LMM) ★NEW',
