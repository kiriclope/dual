...
detectable coding dimension. Instead, the GNG code rotated onto the choice axis and the memory state moved along it to a no-lick set-point whose depth predicted each animal's
