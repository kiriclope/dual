...
| `fig_ed_opto_validation.py` | `python fig_ed_opto_validation.py [--nocap]` | **ED 7** PLACEHOLDER: six labelled boxes for author-supplied histology, placements, FOVs, laser parameters | `figures/ed/{png,svg}/ed_fig7` |
